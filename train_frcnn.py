...
parser.add_option("--network", dest="network", help="Base network to use. Supports vgg or resnet50.", default='resnet50') #vgg
...
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.", default='./checkpoint/model_frcnn_5_epoch.hdf5')
parser.add_option("--input_weight_path", dest="input_weight_path", help="Input path for weights. If not specified, will try to load default weights provided by keras.")

(options, args) = parser.parse_args()
options.train_path ='./data/data/annotations.txt'
options.network ='vgg'
options.input_weight_path='./pre_train/vgg16_weights_tf_kernels_notop.h5'
